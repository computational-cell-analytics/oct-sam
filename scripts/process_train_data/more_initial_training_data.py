...
def main():
    input_folder = "../data/neue-OCTs-17_07_2025"
    # check_training_data(input_folder)

    output_folder = "../data/data_20250717_resaved"
    resave_training_data(input_folder, output_folder)
